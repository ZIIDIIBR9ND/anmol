...
for x in range(1000):
 rr = random.randint
 rc = random.choice
 A = f'Mozilla/5.0 (Linux; Android {str(rr(8,10))}; Samsung {str(rr(4,9))} Build/PPR1.'
...
#User Agnes buatan Asep Yusup 
    ...
    dua  = f"Mozilla/5.0 (Linux; Android {str(rr(7,12))}; Samsung X671) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ {str(rr(75,150))}.0.{str(rr(5111,5999))}.{str(rr(73,99))} Mobile Safari/537.36"
    ...
    empat  = f"Mozilla/5.0 (Linux; Android 12; SM-G973F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36"
...
rgen=f' {K}[{RED}√{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
fst=f'{dot}[{H}sathi{M}={H}abir{M}={H}tisha{M}={H}LALA{M}={H}samim{P}]'
lst=f'{dot}[{H}akter{M}={H}khan{M}={H}hasan{M}={H}TRICKY{M}={H}ali{P}]'
...
def banner():
    #os.system('clear')
    print(f"""   \033[0;33m━━━━━━ZIIDII━━━━━━━━━BR9ND━━━━━━H3R3━━━━━━━━
\033[1;34m       ╗ 
\033[1;33m   
...
\033[0;31m       ║
\033[1;34m       ╚══════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
\033[1;33m━━━━━ZIIDII━━━━━━━BR9ND━━━━━━━━━━━━━━━━━ {P}""")
print(f"""{GREEN}    SELL DONE{P}
 {K}[{H}√{K}]{P} This message is for my haters 
 {K}[{H}√{K}]{P}       {H} The ZIIDII Is BACK 
 {K}[{H}√{K}]{P} Successfully Update Done {H}2.0.10""");print(led)
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract FB-ZIIDII')
    print(f"{K} [{M}0{K}] {WHITE}Exit Tools ");print(led)
    LALA = input(f'{wt}Select menu {M}:{H} ')
    if ZIIDII in ["1","01"]:
        exit()
    elif LALA in ["2","02"]:
        exit()
     ...
     os.system("xdg-open https://github.com/FB-LALA");mainx()
    elif LALA in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/FB.LALA.LALA.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
    elif LALA in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-LALA {P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.LALA.LALA.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.LALA.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/FB.LALA.LALA.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
...
def sep():
    ...
    print(led);print(f'{dot}Total File Ids {M}:{H} ' +
          str(len(open(file_name).read().splitlines())));print(led);print(f'{gen}Example {M}:{H} /sdcard/LALA.txt');print(led)
...
def dupcutter():
    os.system('clear');banner();print(f'{dot}Example   {RED}:{H} /sdcard/LALA.txt');print(led)
    Error = input(f"{wt}{N}File Name {RED}:{H} ");print(led);print(f'{dot}Example   {RED}:{H} /sdcard/LALA.txt');print(led)
